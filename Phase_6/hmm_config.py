...
REGIME_PARAMS = {   'bear': {   'drift_threshold': 0.085,
                'lookback_days': 409,
                'rebalance_max_days': 123,
                'rebalance_min_days': 54},
    'bull': {   'drift_threshold': 0.085,
                'lookback_days': 503,
                'rebalance_max_days': 165,
                'rebalance_min_days': 160},
    'crash': {   'drift_threshold': 0.085,
                 'lookback_days': 335,
                 'rebalance_max_days': 140,
                 'rebalance_min_days': 96}}

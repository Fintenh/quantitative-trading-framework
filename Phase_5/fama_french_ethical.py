...
# Optimal_Standard (20 assets - Efficient Frontier selection)
...
# Optimal_Ethical (20 assets - Genetic Algorithm selection)
...
def plot_factor_comparison(all_results):
    ...
    # Plot 1: Alpha comparison (bar chart)
    ax = axes[0, 0]
    names = []
    alphas = []
    p_values = []
    ...
    # Plot 2: Factor Exposures (grouped bar chart)
    ax = axes[0, 1]
...
def main():
    ...
    # Define universes and their parameters
    universes = {
        'Original_18': (ORIGINAL_UNIVERSE, ORIGINAL_PARAMS),
        'Optimal_Standard': (STANDARD_UNIVERSE, OPTIMAL_STANDARD_PARAMS),
        'Optimal_Ethical': (ETHICAL_UNIVERSE, OPTIMAL_ETHICAL_PARAMS)
    }
    
    # Get returns and run regression for each universe
    all_results = {}
    all_aligned = {}

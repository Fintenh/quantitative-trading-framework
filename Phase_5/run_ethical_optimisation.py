...
Automatically updates ethical_config.py with the optimised parameters.
"""
...
def validate_params(params):
    ...
    if params['rebalance_max_days'] < params['rebalance_min_days']:
        print(f"   Fixing invalid params: rebalance_max ({params['rebalance_max_days']}) < rebalance_min ({params['rebalance_min_days']})")
...
def run_optimisation_for_universe(tickers, universe_name):
    ...
    # Update config with the optimised parameters
...
def main():
    ...
    print("=" * 70)
    print("ethical_config.py has been updated with the optimised parameters")

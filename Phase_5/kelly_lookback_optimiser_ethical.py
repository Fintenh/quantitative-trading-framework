...
Uses CORRECTED Kelly calculation with actual portfolio returns:
...
class BacktestEngineWithKelly(BacktestEngine):
    """
    Phase 5 backtest engine with CORRECTED Kelly calculation.
    Uses equal-weight portfolio returns with actual compounded returns.
    """
    ...
    def _calc_cash_allocation(self, returns):
        """
        Calculate cash allocation using CORRECTED Kelly.
...
# ============================================================================
# PLOT RESULTS - 4 PLOTS (Removed Drawdown)
# ============================================================================

def plot_kelly_results(standard_results, ethical_results):
    """Plot results with 4 subplots (removed drawdown plot)."""

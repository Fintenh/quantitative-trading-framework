...
options_pricer.py
------------------
Phase 1.4: GARCH volatility forecasting and option pricing via Monte Carlo,
benchmarked against Black-Scholes.
"""
...
def simulate_historical(drift, S0, vol, steps=DAYS, n=N_SIMS):
    """Simulate GBM paths under the real-world (historical drift) measure."""
    dt = 1 / steps
...
def plot_payoff_comparison(paths_hist, paths_rn, K, fname):
    """Compare historical vs risk-neutral terminal prices and payoffs."""

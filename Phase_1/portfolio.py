...
Downloads multiple stocks, computes the covariance matrix, performs a
Cholesky decomposition, and constructs the efficient frontier to find
the minimum-variance and maximum-Sharpe portfolios.
"""
...
def portfolio_stats(weights):
    """Return the expected return and volatility for a given weight vector."""

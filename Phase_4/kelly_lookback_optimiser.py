...
class BacktestEngineWithKelly(BacktestEngine):
    """
    Phase 3 backtest engine extended with the Kelly Criterion.
    Uses equal-weight portfolio returns for the Kelly calculation.
    """
    ...
    def _calc_cash_allocation(self, returns):
        ...
        try:
            ...
            if self._debug_count < 10:
                ...
                print(f"      Volatility^2: {volatility**2:.8f}")
                print(f"      f*: {f_star:.4f}")

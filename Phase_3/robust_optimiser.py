...
STOP-LOSS IS DISABLED (fixed at 100%).
"""
...
class RobustOptimiser:
    ...
    def run(self, data, tickers, n_splits=5):
        ...
        print(f"  stop_loss_pct: DISABLED (100%)")
    ...
    def _print_config(self, n_splits):
        ...
        print(f"STOP-LOSS: DISABLED (fixed at 100%)")
        print("=" * 70)
    ...
    def _run_bayesian(self, data):
        ...
        def objective(params):
            ...
            param_dict = {
                ...
                'stop_loss_pct': 1.0,  # Fixed at 100% (disabled)
    ...
    def _select_robust_parameters(self, fold_results):
        ...
        # Weight by Sharpe (ignore negative)
        ...
        for key in params_list[0].keys():
            ...
            if key in ['lookback_days', 'rebalance_min_days', 'rebalance_max_days']:
                robust_params[key] = int(round(weighted_sum / 5) * 5)  # Round to multiple of 5
            else:
                robust_params[key] = round(weighted_sum, 3)
        
        # Ensure stop-loss is always disabled
        robust_params['stop_loss_pct'] = 1.0

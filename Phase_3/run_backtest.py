...
# ================================================================
# FIX: Set Matplotlib backend to one that supports display on macOS
# MacOSX supports both display and saving figures
# ================================================================
import matplotlib
...
def plot_monthly_distribution(monthly_returns, geo_mean, period_name, filename):
    ...
    if len(monthly_returns) == 0:
        print("⚠️ No monthly returns data for distribution plot")
        return
...
if len(monthly_returns) > 0:
    ...
    print("⚠️ Graph 5: No monthly returns data - skipping monthly distribution plot")

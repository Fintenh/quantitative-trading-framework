...
Reads from portfolio_log.csv to show the latest portfolio allocation, working
with either pound values (_value columns) or percentage weights (_weight
columns) depending on what the log contains. Excludes metadata columns like
total_cost from the pie chart, and shows both pounds and percentages in the
printed breakdown.
"""
...
def load_portfolio_data():
    ...
    Works with both the old (_weight) and new (_value) column formats.
    """
...
def main():
    ...
    # -------------------------------------------------------------------
    # Group small assets for the pie chart
    # -------------------------------------------------------------------

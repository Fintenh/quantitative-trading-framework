...
Includes low-controversy Healthcare giants (PFE, ZTS, MDT), a Consumer
Defensive/Discretionary leader (HD), and a sustainable agriculture
equipment leader (DE). Strictly excludes fossil fuels and defense/
war-linked companies.

International tickers use their local exchange suffixes: IBE.MC (Spain)
and NEL.OL (Norway).
"""
...
FINAL_POOL = [
    ...
    "IBE.MC",  # Iberdrola - Spain (renewable utility)
    "BEP",     # Brookfield Renewable - Canada
    "NEL.OL",  # Nel ASA - Norway (hydrogen)
    ...
    # US healthcare (additional low-controversy heavy hitters)
    "PFE",     # Pfizer - Pharmaceuticals (large-cap, opioid legacy settled, strong ESG)
    "ZTS",     # Zoetis - Animal health (spin-off from Pfizer, zero controversy)
    "MDT",     # Medtronic - Medical devices (pacemakers, surgical tools, zero controversy)
    ...
    # US consumer (additional low-controversy heavy hitter)
    "HD",      # Home Depot - Home improvement retail (ESG leader, strong labour practices)
    ...
    # US industrials (sustainable agriculture)
    "DE",      # Deere & Company - Agricultural equipment (enables sustainable farming)

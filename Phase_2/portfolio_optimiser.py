...
def optimise_portfolios(exp_ret, cov, risk_free=0.02, max_weight=1.0):
    """
    Find the Minimum Variance and Maximum Sharpe Ratio portfolios.

    Returns:
        dict: Contains weights, returns, and volatility for both portfolios
    """
    n = len(exp_ret)
...
def generate_portfolio_summary(results):
    """Generate a readable summary of the optimisation results."""
